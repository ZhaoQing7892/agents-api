...
public class CreatedAccessToken {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreatedAccessToken> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatedAccessToken.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatedAccessToken>() {
           @Override
           ...
           @Override
           public CreatedAccessToken read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatedAccessToken instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatedAccessToken given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatedAccessToken
  * @throws IOException if the JSON string is invalid with respect to CreatedAccessToken
  */
  public static CreatedAccessToken fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatedAccessToken.class);
  }

 /**
  * Convert an instance of CreatedAccessToken to an JSON string
  *
  * @return JSON string
  */

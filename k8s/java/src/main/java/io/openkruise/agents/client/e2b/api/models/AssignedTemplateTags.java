...
public class AssignedTemplateTags {
  ...
  public AssignedTemplateTags tags(List<String> tags) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<AssignedTemplateTags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignedTemplateTags.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignedTemplateTags>() {
           @Override

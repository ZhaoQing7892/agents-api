...
public class TemplateTag {
  ...
  public TemplateTag tag(String tag) {
  ...
  **/
  ...
  public TemplateTag buildID(UUID buildID) {
  ...
  **/
  ...
  public TemplateTag createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the TemplateTag instance itself
   */
  public TemplateTag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tag, templateTag.tag) &&
        Objects.equals(this.buildID, templateTag.buildID) &&
        Objects.equals(this.createdAt, templateTag.createdAt)&&
        Objects.equals(this.additionalProperties, templateTag.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tag, buildID, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateTag
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TemplateTag>() {
           ...
           public TemplateTag read(JsonReader in) throws IOException {
             ...
             TemplateTag instance = thisAdapter.fromJsonTree(jsonObj);

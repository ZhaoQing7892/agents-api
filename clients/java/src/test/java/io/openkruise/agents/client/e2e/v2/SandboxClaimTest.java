...
public class SandboxClaimTest extends BaseE2eTest {
    ...
    public void testSandboxClaimBasicFlow() throws Exception {
        ...
        ObjectMeta poolMeta = new ObjectMeta();
        poolMeta.setName(poolName);
        poolMeta.setNamespace(NAMESPACE);
        pool.setMetadata(poolMeta);
        ...
        ObjectMeta claimMeta = new ObjectMeta();
        claimMeta.setName(claimName);
        claimMeta.setNamespace(NAMESPACE);
        claim.setMetadata(claimMeta);
        ...
        assertNull(client.resources(SandboxClaim.class).inNamespace(NAMESPACE).withName(claimName).get());
    }
}

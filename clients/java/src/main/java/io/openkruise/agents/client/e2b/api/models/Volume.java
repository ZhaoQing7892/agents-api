...
public class Volume {
  ...
  **/
   ...
   * @return the Volume instance itself
   */
  public Volume putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.volumeID, volume.volumeID) &&
        ...
        Objects.equals(this.additionalProperties, volume.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeID, name, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Volume>() {
           ...
           public Volume read(JsonReader in) throws IOException {
             ...
             Volume instance = thisAdapter.fromJsonTree(jsonObj);

...
func NewTeam(teamID string, name string, apiKey string, isDefault bool) *Team {
	this := Team{}
	this.TeamID = teamID
	this.Name = name
	this.ApiKey = apiKey
...
// and a boolean to check if the value has been set.
func (o *Team) GetApiKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Team) SetApiKey(v string) {
	o.ApiKey = v
}

// GetIsDefault returns the IsDefault field value
func (o *Team) GetIsDefault() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Team) GetIsDefaultOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Team) SetIsDefault(v bool) {
	o.IsDefault = v
}

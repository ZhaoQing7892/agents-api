...
// Mirrors Python's SandboxInfo class.
...
// Mirrors Python's SandboxApi class in sandbox_api.py.
...
func (s *SandboxApi) SetTimeout(ctx context.Context, sandboxID string, timeout int32) error {
	...
	body := *client.NewSandboxesSandboxIDTimeoutPostRequest(timeout)
...
func (s *SandboxApi) CreateSandbox(ctx context.Context, opts CreateSandboxOpts) (*SandboxCreateResponse, error) {
	body := client.NewCreateSandboxRequest(opts.Template)
...
func (s *SandboxApi) ConnectSandbox(ctx context.Context, sandboxID string, timeout int32) (*client.Sandbox, error) {
	if timeout <= 0 {
		timeout = int32(defaultSandboxTimeout)
	}

	body := client.NewConnectSandbox(timeout)

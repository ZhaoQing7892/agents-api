...
type SandboxLister interface {
	...
	List(selector labels.Selector) (ret []*agentsv1alpha1.Sandbox, err error)
...
type sandboxLister struct {
	listers.ResourceIndexer[*agentsv1alpha1.Sandbox]
}

// NewSandboxLister returns a new SandboxLister.
func NewSandboxLister(indexer cache.Indexer) SandboxLister {
	return &sandboxLister{listers.New[*agentsv1alpha1.Sandbox](indexer, agentsv1alpha1.Resource("sandbox"))}
}

// Sandboxes returns an object that can list and get Sandboxes.
func (s *sandboxLister) Sandboxes(namespace string) SandboxNamespaceLister {
	return sandboxNamespaceLister{listers.NewNamespaced[*agentsv1alpha1.Sandbox](s.ResourceIndexer, namespace)}
}
...
type SandboxNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*agentsv1alpha1.Sandbox, error)

...
type SandboxClaimInformer interface {
	...
	Lister() agentsv1alpha1.SandboxClaimLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgentsV1alpha1().SandboxClaims(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxClaims(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxClaims(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxClaims(namespace).Watch(ctx, options)
			},
		}, client),
		&agentsapiagentsv1alpha1.SandboxClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sandboxClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&agentsapiagentsv1alpha1.SandboxClaim{}, f.defaultInformer)
}

func (f *sandboxClaimInformer) Lister() agentsv1alpha1.SandboxClaimLister {
	return agentsv1alpha1.NewSandboxClaimLister(f.Informer().GetIndexer())
}

...
type SandboxTemplateInformer interface {
	...
	Lister() agentsv1alpha1.SandboxTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgentsV1alpha1().SandboxTemplates(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxTemplates(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxTemplates(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgentsV1alpha1().SandboxTemplates(namespace).Watch(ctx, options)
			},
		}, client),
		&agentsapiagentsv1alpha1.SandboxTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sandboxTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&agentsapiagentsv1alpha1.SandboxTemplate{}, f.defaultInformer)
}

func (f *sandboxTemplateInformer) Lister() agentsv1alpha1.SandboxTemplateLister {
	return agentsv1alpha1.NewSandboxTemplateLister(f.Informer().GetIndexer())
}
